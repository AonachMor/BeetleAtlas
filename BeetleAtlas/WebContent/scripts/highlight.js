/* highlight.js 21.06.2018 — Functions for highlighting cells in results tables */
    ...
    // Take id of clicked cell and targets second table — modified from FlyAtlas at ! positions for single ID left cell
    ...
    {  
		...
		{
    		for (var j=1; j < transTable.rows[i].cells.length; j++)		// !
			{
				if(j==geneCellID) 										// !
				{
					if(i==1)
