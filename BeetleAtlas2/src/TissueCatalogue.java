...
public class TissueCatalogue
{
	...
	private int TISSUE_LIST_LEN = 100;		// length of array (currently only needs 30, so should be ok for a while)
	...
	private int ADULARV_LIST_LEN = 100;		// length of array (currently only needs 24, so should be ok for a while)
