...
{	
	final static  String PAGE_HEAD = 
		...
		+ "<script type=\"text/javascript\" src=\"scripts/beetle2.js\"></script>\n"
		+ "<script type=\"text/javascript\" src=\"scripts/highlight.js\"></script>\n"
		+ "<script type=\"text/javascript\" src=\"scripts/beetleAuto2.js\"></script>\n"
		+ "<script type=\"text/javascript\" src=\"scripts/beetleMenu2.js\"></script>\n"
		+ "<script type=\"text/javascript\" src=\"scripts/drag.js\"></script>\n"
		+ "<link rel=\"stylesheet\" type=\"text/css\" href=\"scripts/beetle2.css\" />\n"
	...
	// Strings for RNA gene and Mitochondrial-encoded gene feedback
	final static String PSEUDOGENE = 
			"<div class=\"ambiguity\">\n<span style=\"color:red;\">These data are for the transcript of a <em>pseudogene</em> that is unlikely to be translated into protein.</span><br />"
			+ "It is therefore advisable to check any positive sequence reads in the UCSC Genome Browser "
			+ "<span class=\"mobileHide\">(link above)</span>.\n</div>\n";
	
	final static String LINC_RNA = 
			"<div class=\"ambiguity\">\n<span style=\"color:red;\">These data are for a <em>lincRNA (Long intervening non-coding RNA)</em> that does not encode a protein.</span><br />"
			+ "It is advisable to check any positive sequence reads in the UCSC Genome Browser "
			+ "<span class=\"mobileHide\">(link above)</span>.\n</div>\n";
	
	final static String SNO_RNA = 
			"<div class=\"ambiguity\">\n<span style=\"color:red;\">These data are for a <em>snoRNA (small nucleolar RNA)</em> involved in processing of ribosomal RNA.</span><br />"
			+ "It is advisable to check any positive sequence reads in the UCSC Genome Browser "
			+ "<span class=\"mobileHide\">(link above)</span>.\n</div>\n";
	
	final static String NC_RNA = 
			"<div class=\"ambiguity\">\n<span style=\"color:red;\">These data are for a <em>ncRNA (non-coding RNA)</em>, i.e. an otherwise uncategorized RNA that does not encode a protein.</span><br />"
			+ "It is advisable to check any positive sequence reads in the UCSC Genome Browser "
			+ "<span class=\"mobileHide\">(link above)</span>.\n</div>\n";
	...
	final static String MISC_RNA = 
			"<div class=\"ambiguity\">\n<span style=\"color:red;\">These data are for an RNA that has been classified as ‘miscellaneous’.</span><br />"
			+ "It is advisable to check any positive sequence reads in the UCSC Genome Browser "
			+ "<span class=\"mobileHide\">(link above)</span>.\n</div>\n";

	final static String MITO = 
			"<div class=\"ambiguity\">\n<span style=\"color:red;\">These data are for a protein encoded in the mitochondrial genome.</span><br />"
			+ "Values for the transcripts of such genes tend to be high, and numerical comparisons should be made with caution. "
			+ "\n</div>\n";
	...
	{ 
		...
		pageList[GENE] = new PageDescriptor(GENE, "Gene", "toGeneForm()", "<body onload=\"setSpan('.plusMinus'," + includeErrors + "); setRow('wholesome'," + showWhole + "); setFocus(); setHash('mobileTargetG'); createLink();\" onkeypress=\"geneKey2(event);\">\n", true);
		...
		pageList[PROFILE] = new PageDescriptor(PROFILE, "Profile", "toProfileForm()", "<body onload=\"setSpan('.plusMinus'," + includeErrors + "); setRow('wholesome'," + showWhole + "); setFocus(); setHash('mobileTargetP'); createLink();\" onkeypress=\"profileKey2(event);\">\n", true);		
	...
	public String getPageTop(int pagePos)
	{
		...
		// link for Switch to OGS3 mode — hard-coded except for ensuring page maintained
		if(pageList[GENE].getPagePos() == pagePos)
		{;}//{ pBuilder.append("<li><a href=\"https://motif.mvls.gla.ac.uk/BeetleAtlas/?page=gene\">OGS3 mode</a></li>\n");}
		else if (pageList[TISSUE].getPagePos() == pagePos)
		{;}//{ pBuilder.append("<li><a href=\"https://motif.mvls.gla.ac.uk/BeetleAtlas/?page=top\">OGS3 mode</a></li>\n");}	
		else if (pageList[CATEGORY].getPagePos() == pagePos)
		{;}//{ pBuilder.append("<li><a href=\"https://motif.mvls.gla.ac.uk/BeetleAtlas/?page=go\">OGS3 mode</a></li>\n");}
		else if (pageList[DEVELOPMENT].getPagePos() == pagePos)
		{;}//{ pBuilder.append("<li><a href=\"https://motif.mvls.gla.ac.uk/BeetleAtlas/?page=devel\">OGS3 mode</a></li>\n");}
		else if (pageList[EMBRYO].getPagePos() == pagePos)
		{;}//{ pBuilder.append("<li><a href=\"https://motif.mvls.gla.ac.uk/BeetleAtlas/?page=embryo\">OGS3 mode</a></li>\n");}
		else if (pageList[PROFILE].getPagePos() == pagePos)
		{;}//{ pBuilder.append("<li><a href=\"https://motif.mvls.gla.ac.uk/BeetleAtlas/?page=profile\">OGS3 mode</a></li>\n");}
		else if (pageList[DOCS].getPagePos() == pagePos)
		{;}//{ pBuilder.append("<li><a href=\"https://motif.mvls.gla.ac.uk/BeetleAtlas/?page=help\">OGS3 mode</a></li>\n");}
		else if (pageList[FEEDBACK].getPagePos() == pagePos)
		{;}//{ pBuilder.append("<li><a href=\"https://motif.mvls.gla.ac.uk/BeetleAtlas/?page=contact\">OGS3 mode</a></li>\n");}
		else
		{;}//{ pBuilder.append("<li><a href=\"https://motif.mvls.gla.ac.uk/BeetleAtlas/index.html\">OGS3 mode</a></li>\n"); }
	...
	{
		StringBuilder mBuilder = new StringBuilder();	
		mBuilder.append("<div id=\"title625\"> <img class=\"shrinkfit\" alt=\"\" src=\"images/titleTbN625.jpg\" /> </div>\n");
		mBuilder.append("<div id=\"title500\"> <img class=\"shrinkfit\" alt=\"\" src=\"images/titleTbN500.jpg\" /> </div>\n");	
		mBuilder.append("<div id=\"title400\"> <img class=\"shrinkfit\" alt=\"\" src=\"images/titleTbN400.jpg\" /> </div>\n");			
		...
		mBuilder.append("<li><a href=\"https://motif.mvls.gla.ac.uk/BeetleAtlas/index.html\">OGS3 mode</a></li>\n");
		mBuilder.append("</ul>\n");
		mBuilder.append("</div>\n");
		return mBuilder.toString();
	}
	...
	public static String getDownloadLink(Gene gene, boolean transcript)
	{
		...
		return("<a href=\"/BeetleDirect2/index.html?geneID=" + ncbiID + "&amp;tableOut=" + tableOut + 
