...
{
	String [] idList;						// array to hold NCBI IDs retrieved in query
	...
	public CategorySearch(String stage, int tissueID, String order, boolean byAbundance, String keyword, int displayMax,TissueCatalogue tCat)
	{
		...
		if(byAbundance)
		{
			// get list of NCBI IDs satisfying the keyword/tissue criteria
			...
			// get Expression object for each of NCBI IDs retrieved (through GeneSearch)
	...
	// Get sorted list of NCBI IDs of genes in the selected category that are most abundant in a particular tissue
	...
	// Get sorted list of NCBI IDs  of genes in the selected category that are most enhanced in a particular tissue
