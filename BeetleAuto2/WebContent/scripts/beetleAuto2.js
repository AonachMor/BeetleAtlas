// beetleAuto2.js 
// from original beetleAuto.js 23.06.2018
...
function initVars() 
{
	...
	if(document.getElementById("ncbiID").checked == true)
	{
		searchType = "ncbiID";
	}
	else if(document.getElementById("ncbiSymbol").checked == true)
	{
		searchType = "ncbiSymbol";
	}
	else if(document.getElementById("product").checked == true)
	{
		searchType = "product";
	}
	...
	else if(document.getElementById("tcID").checked == true)
	{
		searchType = "tcID";
	}
	else
...
function findNames() 
{
	...
	if (inputField.value.length > 0) 
	{
		...
		var url = "/BeetleAuto2/index.html?gene=" + encFieldValue
