...
// TODO Thin out as only idType allowed here is geneID
...
{		
	...
	{		
		...
		{
			geneinfoQuery = "INFO_FROM_PRODUCT";
			flyQy = false;
		}
		...
		if(!geneinfoQuery.equals("") && flyQy)
		{
			...
			// Run a GeneSearch using these IDs — is this possible?
		...
		// TRIBOLIUM ID selected: make queries if valid search term and not Fly
		if(!geneinfoQuery.equals("") && !flyQy)
		{
			// Make connection
			Connect cnt = new Connect();
