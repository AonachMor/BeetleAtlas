// BeetleDirect2: Servlet class of text download utility for tables in BeetleAtlas 2
// Adapted from FA2Direct — DPL 10.03.2021
...
public class BeetleDirect2 extends HttpServlet 
{
	...
	{			
		...
		//System.out.println("tableOut: " + tableOut);
