...
public class Tissue
{
	...
	private String age;				// Age — null for non-embryo
	...
	public Tissue(int tissueID, String stage, String age, String sex, String tissueName, 
			String abbreviation, int uniTissueID, boolean reference)
	{
